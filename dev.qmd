...
![Une section de fiche générée automatiquement par Quarto à partir des données de projections.](media/44.png){#fig-dep width=70%}

<span class="vert">**Résultat :** Le temps total de mise à jour annuelle des fiches de projections est passé de plusieurs jours à quatre minutes. Le risque d'erreur a été minimisé par la suppression de toutes les étapes manuelles.</span>
...
![Schéma de fonctionnement de l'application, avec un exemple de graphique de sortie.](media/shinyapp.png){#fig-shiny width=70%}
